...
// specialBits contain the special bits, which are not supported by gxzz.
...
// acceptable for gxzz users. PathError provides information about the
...
// relevant for users of the gxzz program. This function converts a
