...
// Command gxzz supports the compression and decompression of LZMA files.
//
// Use gxzz -h to get information about supported flags.
package main

//go:generate xb cat -o licenses.go xzLicense:github.com/chz100p/xz/LICENSE goLicense:~/go/LICENSE
...
import (
	...
	"github.com/chz100p/xz/internal/gflag"
	"github.com/chz100p/xz/internal/term"
	"github.com/chz100p/xz/internal/xlog"
)

const (
	usageStr = `Usage: gxzz [OPTION]... [FILE]...
...
Report bugs using <https://github.com/chz100p/xz/issues>.
`
)
...
func licenses(w io.Writer) {
	out := `
github.com/chz100p/xz -- xz for Go
====================================
...
The gxzz program contains the packages gflag and xlog that are
...
Use -f to force compression. For help type gxzz -h.`)
	}
